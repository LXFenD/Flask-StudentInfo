...
# The theme to use for HTML and HTML Help common.  See the documentation for
...
# Additional templates that should be rendered to common, maps page names to
# template names.
...
# If true, the index is split into individual common for each letter.
#html_split_index = False

# If true, links to the reST sources are added to the common.
...
# If true, an OpenSearch description file will be output, and all common will
